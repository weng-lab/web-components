...
export const ontologyDownloadMap: Record<string, DownloadLink[]> = {
  ...
  blood_vessel: [{ label: "All Biosamples", filename: "blood_vessel.noccl.cCREs.bed" }],
  bone: [
  ...
  embryo: [{ label: "All Biosamples", filename: "embryo.noccl.cCREs.bed" }],
  epithelium: [{ label: "All Biosamples", filename: "epithelium.noccl.cCREs.bed" }],
  esophagus: [{ label: "All Biosamples", filename: "esophagus.noccl.cCREs.bed" }],
  eye: [
  ...
  limb: [{ label: "All Biosamples", filename: "limb.noccl.cCREs.bed" }],
  liver: [
  ...
  lymphoid_tissue: [{ label: "All Biosamples", filename: "lymphoid_tissue.noccl.cCREs.bed" }],
  mouth: [
  ...
  small_intestine: [{ label: "All Biosamples", filename: "small_intestine.noccl.cCREs.bed" }],
  spinal_cord: [{ label: "All Biosamples", filename: "spinal_cord.noccl.cCREs.bed" }],
  spleen: [{ label: "All Biosamples", filename: "spleen.noccl.cCREs.bed" }],
  stomach: [{ label: "All Biosamples", filename: "stomach.noccl.cCREs.bed" }],
  testis: [
  ...
  vagina: [{ label: "All Biosamples", filename: "vagina.noccl.cCREs.bed" }],
};
