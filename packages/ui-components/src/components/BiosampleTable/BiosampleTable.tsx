...
export function BiosampleTable(props: BiosampleTableProps): JSX.Element {
  ...
  // Update the added autogenerated rows when the filter model changes (or else group checkbox state is stale)
  useEffect(() => {
    return apiRef.current?.subscribeEvent("filterModelChange", () => {getAndSetRowSelectionModel(apiRef, selected, setRowSelectionModel)});
  }, [apiRef, selected]);
