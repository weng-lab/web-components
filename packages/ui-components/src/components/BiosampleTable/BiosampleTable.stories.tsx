...
import { gridVisibleRowsSelector, isAutogeneratedRow, useGridApiRef } from "@mui/x-data-grid-premium";
  ...
  render: () => {
    ...
    return (
      <BiosampleTable
        ...
        onReady={() => apiRef.current!.subscribeEvent("rowExpansionChange", (_params, _event, details) => {
